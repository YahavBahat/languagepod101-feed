...
https://www.japanesepod101.com/helpcenter/getstarted/how-to-save-lessons/
...
My Feed (Premium subscription required): https://www.japanesepod101.com/helpcenter/getstarted/how-to-save-lessons/#myfeed
...
```
python3 CLI.py --root-url https://www.japanesepod101.com --download-path Japanesepod-101 --feed-path /Downloads/MyJapaneseFeed.xml --content ALL --email EMAIL --password PASSWORD
```
